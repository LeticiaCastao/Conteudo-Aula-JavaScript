...
const euMesmo = new Pessoa("Letícia", "Castão", 20, "Brasil");

const meuMae = new Pessoa("Santos", "Eliene", 38, "Brasil");
...
const minhaMoto = new Veiculo("Ducati", "Panigale", "216cv", "Azul", 2019, 2);

console.log(minhaMoto);

const meuCarro = new Veiculo("Porsche", "944", "240cv", "Branco", 1988, 4);
